...
Note: For our quick start we won't go into it, but you also have the option of customizing your app (custom prompting, search strategies, etc.). Go to [App Configurations](../api_reference/app_configurations/app_configurations_intro) to learn more. 
