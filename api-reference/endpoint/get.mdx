...
<ParamField body="prompt" type="string">
  Customize the output of your app (e.g. having it follow a certain output pattern - `SQL Expression:`, or make it rewrite answers to follow your style - e.g. `You're an expert at writing exciting LinkedIn posts. Make sure you include a bunch of emojis`). 
</ParamField>
