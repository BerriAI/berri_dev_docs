...
<ParamField query="rationale" type="string">
  The model is prompted to come up with a rationale/think before giving it's answer. The returned format is: `Rationale: <model rationale> Answer: <model answer>`. 
