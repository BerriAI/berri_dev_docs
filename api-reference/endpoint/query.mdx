...
<ParamField query="rational" type="string">
  Has to be either 'True' or 'False'. 
  This makes the model give it's rationale for it's response. 
  Always in the format: 'Rational: <model rational> Answer: <model answer>'
  This helps improve model accuracy by up to 30%. 
</ParamField>
