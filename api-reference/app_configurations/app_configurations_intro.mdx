...
1. [URL Configs](../app_configurations/url_configuration) (Use this if you want to query a scraped website, or connect with an API Endpoint)
2. [File Configs](../app_configurations/url_configuration) (Use this if you want to upload a single file - .csv, .pdf. .docx, .txt, .pptx **or** multiple files - .zip)
